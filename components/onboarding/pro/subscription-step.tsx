...
export function SubscriptionStep() {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <DialogTitle className="sr-only">Choisissez votre plan d'abonnement</DialogTitle>
      <DialogDescription className="sr-only">
        Sélectionnez l'offre qui correspond le mieux à vos besoins. Tous nos plans incluent un essai gratuit.
      </DialogDescription>
