                ...
                >
                  ...
                  <div
                    className={cn(
                      ...
                      event.status === 'confirmé' ? 'bg-primary' : 'bg-secondary'
                    )}
                  />
                  ...
                  <div className='p-4 pl-6'>
                    ...
                    <div className='flex items-center justify-between mb-4'>
                      ...
                      <Badge
                        variant={event.status === 'confirmé' ? 'default' : 'secondary'}
                    ...
                    <div className='flex items-center gap-4'>
                      ...
                      <div className='flex-1 space-y-1'>
                        <div className='flex items-center gap-2'>
                          <h3 className='font-semibold text-lg tracking-tight'>{event.title}</h3>
                        ...
                        <div className='flex items-center gap-1 text-sm text-muted-foreground'>
                          <span>avec</span>
                          <span className='font-medium text-foreground'>{event.doctor}</span>
                          <span>pour</span>
                          <span className='font-medium text-foreground'>{event.petName}</span>
                        </div>
            ...
            <SheetContent className="sm:max-w-[500px] overflow-y-auto">
              ...
              >
                    ...
                    <div className='flex items-center gap-4'>
                      ...
                      >
                        <Avatar className='h-16 w-16 ring-4 ring-primary/10'>
                          <AvatarImage src={selectedEvent.petAvatar} alt={selectedEvent.petName} />
                          <AvatarFallback>{selectedEvent.petInitial}</AvatarFallback>
                        </Avatar>
                      </motion.div>
                      <div className='space-y-1'>
                ...
                >
                  <Badge
                    className='w-fit'
                    variant={selectedEvent.status === 'confirmé' ? 'default' : 'secondary'}
                  >
                      ...
                      <HoverCard>
                        ...
                        <HoverCardContent className="w-80">
                          <div className="flex justify-between space-x-4">
                            <div className="space-y-1">
                              <h4 className="text-sm font-semibold">{selectedEvent.doctor}</h4>
                              <p className="text-sm text-muted-foreground">
                                Professionnel expérimenté avec plus de {selectedEvent.doctorExperience} d'expérience
                              </p>
                            </div>
                          </div>
                        </HoverCardContent>
                      ...
                      <Card className="shadow-md">
                        <CardContent className="p-4">
                          <div className='flex items-start gap-4'>
                            <Avatar className='h-16 w-16 ring-4 ring-primary/10'>
                              <AvatarImage src={selectedEvent.doctorAvatar} alt={selectedEvent.doctor} />
                              <AvatarFallback>{selectedEvent.doctor[0]}</AvatarFallback>
                            </Avatar>
                            <div className='flex-1'>
                              <div className='flex items-center gap-2 mb-2'>
                                <h3 className='font-semibold text-lg'>{selectedEvent.doctor}</h3>
                                <Badge variant="outline" className='ml-2'>
                              ...
                              <div className='space-y-2 text-sm text-muted-foreground'>
                                ...
                                <div className='flex items-center gap-2'>
                                  ...
                                  <span>{selectedEvent.doctorExperience} d'expérience</span>
                                </div>
                              </div>
                            </div>
                          </div>
                  ...
                  >
                    ...
                    <div className='rounded-xl border p-4 bg-muted/50'>
                      <p className='text-sm text-muted-foreground'>
                        Veuillez arriver 5 minutes avant votre rendez-vous. En cas d'empêchement, merci de nous prévenir au moins 24h à l'avance.
                      </p>
                    </div>
                  </motion.div>
