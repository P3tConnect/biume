    ...
    <EmailLayout preview={`New Report Available for ${petName}`}>
      <Section>
        ...
        <Text className="text-gray-600 mb-4">
          A new report has been generated for {petName} on {reportDate}. You can
          view the complete details and any recommendations by clicking the
          button below.
        </Text>
        ...
        <Text className="text-gray-600 mb-4">
          If you have any questions about the report or would like to discuss
          the findings, please don't hesitate to reach out to your care
          provider.
        </Text>
