        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          <div className="relative z-10 text-center lg:text-left">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground mb-8 max-w-lg mx-auto lg:mx-0">
              Une application conçue avec amour pour vous aider à prendre soin
              de vos compagnons comme ils le méritent.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 mb-12 justify-center lg:justify-start">
              <Button
                size="lg"
                className="custom-button h-12 sm:h-14 px-6 sm:px-8 text-base sm:text-lg bg-primary"
              >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-6">
              <div className="flex -space-x-4">
                {[1, 2, 3, 4, 5].map((i) => (
                  <div
                    key={i}
                    className="w-10 sm:w-12 h-10 sm:h-12 rounded-full border-4 border-background overflow-hidden"
                  >
                    <Image
