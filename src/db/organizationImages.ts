...
export const organizationImagesInsertSchema = createInsertSchema(organizationImages)
export const organizationImagesSelectSchema = createSelectSchema(organizationImages)
