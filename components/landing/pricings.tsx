        ...
        {siteConfig.pricing.map((plan, index) => (
          <motion.div
            ...
            className={cn(
              ...
              plan.isPopular ? "border-secondary border-[2px]" : "border-border",
              index === 0 || index === siteConfig.pricing.length - 1
          ...
          >
            {plan.isPopular && (
              <div className="absolute top-0 right-0 bg-secondary py-0.5 px-2 rounded-bl-xl rounded-tr-xl flex items-center">
            ...
            <div>
              ...
              <Link
                ...
                className={cn(
                  ...
                  "transform-gpu ring-offset-current transition-all duration-300 ease-out hover:ring-2 hover:ring-secondary hover:ring-offset-1 hover:bg-secondary hover:text-white",
                  plan.isPopular
