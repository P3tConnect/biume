...
export const features = [
  ...
  },
  {
    ...
    icon: Clock,
    details:
      "Notre calendrier synchronisé affiche en temps réel les disponibilités de votre vétérinaire. Fini les allers-retours par téléphone pour trouver un créneau disponible. Les plages horaires sont mises à jour instantanément, vous garantissant une visibilité claire sur les disponibilités.",
    image:
  ...
  },
  {
    ...
    icon: MessageSquare,
    details:
      "Notre système de notification intelligent vous envoie des rappels personnalisés par email et SMS. Vous recevez un premier rappel 48h avant votre rendez-vous, puis un second 24h avant. Ces alertes incluent toutes les informations importantes : date, heure, lieu et préparatifs éventuels.",
    image:
  ...
  },
  {
    ...
    icon: CreditCard,
    details:
      "Notre système de paiement en ligne est entièrement sécurisé et crypté. Vous pouvez régler votre consultation à l'avance ou choisir de payer sur place. Nous acceptons toutes les cartes bancaires principales et proposons des reçus numériques instantanés.",
    image:
  ...
  },
  {
    ...
    icon: Stethoscope,
    details:
      "Gardez une trace complète de la santé de votre animal : vaccins, traitements, ordonnances et résultats d'analyses. Toutes ces informations sont accessibles en quelques clics et peuvent être partagées facilement avec d'autres vétérinaires si nécessaire.",
    image:
      "https://images.unsplash.com/photo-1629909613654-28e377c37b09?w=800&auto=format&fit=crop",
    cta: "Voir mon carnet de santé",
