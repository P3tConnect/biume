...
import { capitalizeFirstLetter } from "@/components/dashboard/shortcuts/calendar-widget"
import { groupAppointmentsByTimeSlot } from "@/components/calendar/utils"
import { AppointmentGroupClient } from "./appointment-group-client"
...
export function CalendarSidebarClient({ selectedDate, appointments, onNewAppointment }: CalendarSidebarProps) {
          ...
          {selectedDate ? (
            appointments.length > 0 ? (
              groupedAppointments
                ...
                .map((group, index) => <AppointmentGroupClient key={index} appointments={group} />)
            ) : (
