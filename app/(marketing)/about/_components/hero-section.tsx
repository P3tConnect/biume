      ...
      <div className="container relative mx-auto px-4 py-20">
        <div className="max-w-3xl">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground">
            Biume aide les professionnels de santé animale à se concentrer sur l&apos;essentiel : le bien-être de leurs
            patients, en simplifiant la gestion de leur activité.
          </p>
        </div>
      </div>
    </section>
