import { Calendar, Gift, Heart, Shield, Users, Zap } from "lucide-react"
...
export const features = [
  ...
  },
  {
    ...
    description: "Planifiez et gérez tous les rendez-vous de vos clients en quelques clics.",
    icon: Calendar,
    details:
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1516916759473-600c07bc12d4?w=800&auto=format&fit=crop",
  ...
  },
  {
    ...
    description: "Les délais de rétractation sont un atout important en cas de problème avec un client.",
    icon: Zap,
    details:
    ...
    image: "https://images.unsplash.com/photo-1517849845537-4d257902454a?w=800&auto=format&fit=crop",
    cta: "Configurer les alertes",
    ctaLink: "/about/pro/settings",
  },
  {
    title: "Intelligence artificielle",
    description: "Profitez d'un assistant IA pour optimiser vos soins et développer votre activité.",
    icon: Gift,
    details:
