      ...
      slots: [
        {
          ...
          startTime: new Date(slot.start).toLocaleTimeString("fr-FR", {
            hour: "2-digit",
            minute: "2-digit",
            hour12: false,
          }),
          endTime: new Date(slot.end).toLocaleTimeString("fr-FR", {
            hour: "2-digit",
            minute: "2-digit",
            hour12: false,
          }),
      ...
      <div className="relative">
        <Credenza open={isOpen} onOpenChange={setIsOpen}>
          <CredenzaContent className="sm:max-w-[800px]">
            <VisuallyHidden>
              <CredenzaTitle>{isEditing ? "Modifier le créneau" : "Ajouter des créneaux"}</CredenzaTitle>
            </VisuallyHidden>
            <SlotsForm
