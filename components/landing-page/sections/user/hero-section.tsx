    ...
    <section className="relative pt-16 pb-24 md:pt-24 md:pb-32 overflow-hidden">
      ...
      <div className="container mx-auto">
        <div className="flex flex-col items-center text-center mb-10 md:mb-12">
          ...
          >
            Biume connecte vos animaux aux meilleurs professionnels de santé
            près de chez vous. Prenez rendez-vous en quelques clics et suivez
            tous leurs soins en un seul endroit.
          </motion.p>
