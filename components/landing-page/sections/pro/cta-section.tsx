            ...
            <div className="relative z-10 grid md:grid-cols-2 gap-8 p-8 md:p-12">
              ...
              >
                ...
                <p className="text-lg mb-8 text-muted-foreground">
                  Notre plateforme tout-en-un vous permet de vous concentrer sur
                  ce qui compte vraiment : le soin de vos patients. Simplifiez
                  votre administration, améliorez votre efficacité et développez
                  votre activité.
                </p>
                  ...
                  {[
                    {
                      ...
                      description:
                        "Démarrez en moins de 48h avec notre processus d'embarquement optimisé",
                    },
                    {
                      icon: MountainSnow,
                      title: "Évolutivité sans limites",
                      description:
                        "Adapté aux professionnels indépendants comme aux grandes cliniques multi-sites",
                    },
                  ].map((feature, index) => (
                    <motion.div
                      key={index}
