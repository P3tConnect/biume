...
const sparklineAppointments = [{ value: 20 }, { value: 25 }, { value: 22 }, { value: 28 }, { value: 24 }, { value: 30 }]

const sparklinePatients = [{ value: 40 }, { value: 42 }, { value: 38 }, { value: 45 }, { value: 43 }, { value: 48 }]
...
const sparklineSatisfaction = [{ value: 95 }, { value: 96 }, { value: 97 }, { value: 96 }, { value: 98 }, { value: 98 }]
          ...
          <div className="flex justify-between items-end">
            <div>
              <div className="text-3xl font-bold">
                ...
                {title === "Satisfaction" && <span className="text-sm font-medium">%</span>}
              </div>
    ...
    <>
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        <MetricCard
          title="Rendez-vous"
          value={24}
          icon={<CalendarIcon className="w-4 h-4 text-indigo-600 dark:text-indigo-400" />}
        ...
        <MetricCard
          title="Patients"
          value={45}
          icon={<PawPrintIcon className="w-4 h-4 text-rose-600 dark:text-rose-400" />}
        ...
        <MetricCard
          title="Soins"
          value={128}
          icon={<ActivityIcon className="w-4 h-4 text-emerald-600 dark:text-emerald-400" />}
        ...
        <MetricCard
          title="Satisfaction"
          value={98}
          icon={<HeartPulseIcon className="w-4 h-4 text-amber-600 dark:text-amber-400" />}
