...
const ClientInformationForm = ({ form }: { form: UseFormReturn<z.infer<typeof clientOnBoardingSchema>> }) => {
      ...
      <form className="space-y-6 w-full">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="w-full">
                ...
                <FormControl>
                  <Input type="text" placeholder="Pays" {...field} value={field.value ?? ""} />
                </FormControl>
              </FormItem>
            )}
          />
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="w-full">
                ...
                <FormControl>
                  <Input type="text" placeholder="Ville" {...field} value={field.value ?? ""} />
                </FormControl>
              </FormItem>
            )}
          />
        ...
        <div className="flex flex-row gap-6">
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="w-full">
                ...
                <FormControl>
                  <Input type="text" placeholder="Numéro et nom de la rue" {...field} value={field.value ?? ""} />
                </FormControl>
              </FormItem>
            )}
          />
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="w-full">
                <FormLabel className="text-sm font-semibold">Code Postal</FormLabel>
                <FormControl>
                  <Input type="number" placeholder="Code postal" {...field} value={field.value ?? ""} />
                </FormControl>
              </FormItem>
            )}
          />
        ...
        <div className="flex flex-row gap-6">
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="w-full">
                <FormLabel className="text-sm font-semibold">Numéro de téléphone</FormLabel>
                <FormControl>
                  <Input type="text" placeholder="Numéro de téléphone" {...field} value={field.value ?? ""} />
                </FormControl>
              </FormItem>
            )}
          />
