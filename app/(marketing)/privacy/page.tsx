        ...
        >
          ...
          <div className="space-y-8 text-foreground/90">
            <section className="space-y-4">
              ...
              <p>
                Chez Biume, nous accordons une grande importance à la protection
            ...
            <section className="space-y-4">
              ...
              <p>
                ...
                directement lorsque vous créez un compte, utilisez notre
                application ou contactez notre service client. Ces informations
                peuvent inclure :
              </p>
            ...
            <section className="space-y-4">
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>
                  Avec nos prestataires de service qui nous aident à fournir
                  notre service
                </li>
            ...
            <section className="space-y-4">
              ...
              <p>
                ...
                (RGPD), vous disposez de droits concernant vos données
