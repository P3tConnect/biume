...
import { ArrowRightCircle, FileText, Shield, LockKeyhole } from "lucide-react"
          ...
          <Card>
            <CardContent className="pt-6 flex flex-col items-center justify-center text-center p-8">
              ...
              <p className="text-sm text-muted-foreground mb-4">
                Vous n'avez pas les autorisations nécessaires pour accéder aux documents de {animal.name}.
                Seuls les vétérinaires et administrateurs peuvent consulter ces documents.
              </p>
            </CardContent>
          </Card>
        </motion.div>
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }}>
              <Card>
                <CardContent className="pt-6 flex flex-col items-center justify-center text-center p-8">
                  ...
                  <p className="text-sm text-muted-foreground mb-4">
                    Aucun document n'a encore été enregistré pour {animal.name}.
                  </p>
                </CardContent>
              </Card>
            </motion.div>
