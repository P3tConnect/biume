          ...
          <ScrollArea className="h-[280px] pr-4">
            <div className="space-y-2">
              {reservations.map((reservation) => (
                <div
                  key={reservation.id}
                  className={`relative overflow-hidden group p-4 bg-white dark:bg-slate-800 shadow-sm hover:shadow-md transition-all duration-200 rounded-xl border-l-4 ${reservation.conflicts ? "border-l-destructive" : "border-l-green-500"
                    }`}
