...
export default function Footer() {
  return (
    <footer id="footer" className="h-[366px] w-full bg-dark">
      <div className="flex flex-col h-full w-full">
        <div className="flex flex-col justify-center content-center items-center py-10 px-10 text-center w-full h-full">
          <Image src="/assets/images/title.png" alt="logo pawthera" width={346} height={55}/>
        ...
        <div className="flex flex-col md:flex-row justify-between mb-10 px-10">
          ...
          <div className="text-center md:text-left">
            <p className="text-white">Copyright © 2024 PawThera. Tous droits réservés.</p>
          </div>
        </div>
      </div>
    </footer>
