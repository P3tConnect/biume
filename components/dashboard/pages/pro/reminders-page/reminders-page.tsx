  ...
  return (
    <Card className="w-full h-full rounded-2xl">
      <CardHeader className="flex flex-row items-center justify-between">
        <CardTitle className="text-lg font-semibold text-gray-700 dark:text-gray-200">Mes Rappels</CardTitle>
        <Credenza>
          ...
          <CredenzaContent>
            <CredenzaHeader>
              <CredenzaTitle>{isEditMode ? "Modifier le rappel" : "Créer un rappel"}</CredenzaTitle>
              <CredenzaDescription>
                {isEditMode
                          ...
                          value={
                            field.value
                              ? field.value.toISOString().split("T")[0] +
                                "T" +
                                field.value.toISOString().split("T")[1].split(".")[0]
                              : ""
                          }
                        />
                      </FormControl>
      ...
      <CardContent>
        <div className="space-y-4">
          {reminders.map(reminder => (
            ...
            >
              <div className="flex-1">
                ...
                {reminder.description && <p className="text-gray-600 dark:text-gray-300">{reminder.description}</p>}
          ...
          {reminders.length === 0 && (
            <div className="text-center py-8 text-gray-500 dark:text-gray-400">Aucun rappel pour le moment</div>
          )}
        </div>
      </CardContent>
    </Card>
