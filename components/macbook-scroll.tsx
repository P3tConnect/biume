...
export const MacbookScroll = ({
  ...
  const rotate = useTransform(scrollYProgress, [0.1, 0.12, 0.3], [-30, -30, 0]);
  ...
  return (
    ...
    >
      ...
      />
      {/* Base area */}
      <div className="h-[26rem] w-[40rem] bg-gray-200 dark:bg-[#272729] rounded-2xl overflow-hidden relative -z-10">
        {/* above keyboard bar */}
  ...
  return (
    <div className="relative [perspective:1200px]">
      <div
        ...
        className="h-[16rem] w-[40rem] bg-[#010101] rounded-2xl p-2 relative"
      >
        <div
          style={{
      ...
      <motion.div
        ...
        className="h-96 w-[34rem] absolute inset-0 bg-[#010101] ml-14 rounded-2xl p-2"
      >
  ...
  return (
    <div className="h-full rounded-md bg-[#050505] mx-1 p-1">
      ...
      <Row>
        ...
        <div className="w-[8rem] mt-[4px] h-6 rounded-[4px] flex flex-col justify-end items-center">
