    ...
    <Card className="rounded-2xl overflow-hidden">
      <CardHeader>
        <div className="flex justify-between items-center">
          <CardTitle className="text-base font-medium">Meilleurs clients</CardTitle>
              ...
              <CardContent className="p-4">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-muted-foreground">{client.appointments} rendez-vous</p>
                  </div>
                </div>
                <div className="text-right">
                  <p className="text-lg font-bold text-blue-600 dark:text-blue-400">{client.total}€</p>
