    ...
    <div className="h-screen w-screen bg-background">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
          ...
          <div className="space-y-8 text-foreground/90">
            <section className="space-y-4">
              ...
              <p>
                Bienvenue sur Biume. Les présentes Conditions Générales d&apos;Utilisation régissent votre utilisation
                de notre application et des services associés. En accédant à notre plateforme ou en l&apos;utilisant,
            ...
            <section className="space-y-4">
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  <strong>Service</strong> : l&apos;application Biume et toutes ses fonctionnalités
                </li>
                <li>
                  <strong>Utilisateur</strong> : toute personne qui accède ou utilise le Service
                </li>
                <li>
                  <strong>Compte</strong> : l&apos;espace personnel créé lors de l&apos;inscription
                </li>
                <li>
                  <strong>Contenu</strong> : données, textes, images et autres éléments partagés via le Service
                </li>
              </ul>
            </section>

            <section className="space-y-4">
              <h2 className="text-2xl font-semibold text-foreground">Inscription et compte</h2>
              <p>
                Pour utiliser certaines fonctionnalités de notre Service, vous devez créer un compte. Vous êtes
                responsable du maintien de la confidentialité de vos informations de connexion et de toutes les
                activités qui se produisent sous votre compte.
              </p>
            </section>

            <section className="space-y-4">
              <h2 className="text-2xl font-semibold text-foreground">Utilisation du service</h2>
              <p>
                Vous vous engagez à utiliser notre Service conformément aux présentes conditions et à toutes les lois
                applicables. Vous ne devez pas :
              </p>
              <ul className="list-disc pl-6 space-y-2">
                <li>Utiliser le Service d&apos;une manière qui pourrait l&apos;endommager</li>
                <li>Tenter d&apos;accéder à des parties du Service auxquelles vous n&apos;êtes pas autorisé</li>
                <li>Utiliser le Service pour distribuer des contenus illégaux ou nuisibles</li>
            ...
            <section className="space-y-4">
              ...
              <p>
                Le Service et son contenu original, fonctionnalités et fonctionnalités sont la propriété de Biume et
                sont protégés par les lois internationales sur le droit d&apos;auteur et la propriété intellectuelle.
              </p>
            </section>

            <section className="space-y-4">
              <h2 className="text-2xl font-semibold text-foreground">Modifications des conditions</h2>
              <p>
      ...
      <footer className="container mx-auto px-4 py-8 border-t border-border mt-12">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-foreground/60">© {new Date().getFullYear()} Biume. Tous droits réservés.</p>
