    ...
    <EmailLayout preview={`Message de contact de ${name} - ${subject}`}>
      ...
      <Section className="bg-white rounded-xl p-6 border border-gray-100 mb-6">
        ...
        <div className="text-gray-600 mb-4">
          <Text className="m-0"><strong>Nom :</strong> {name}</Text>
          <Text className="m-0"><strong>Email :</strong> {email}</Text>
          {subject && <Text className="m-0"><strong>Sujet :</strong> {subject}</Text>}
        </div>
